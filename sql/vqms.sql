...
-- ============================================================
-- 五B、第26条母线电压考核（季度曲线对账，2026-09-04）
-- ============================================================

-- 14、季度母线电压考核曲线（调度按季下发；对账基准）
drop table if exists vqms_art26_curve;
create table vqms_art26_curve (
...
-- ============================================================
-- 五C、第27条动态无功补偿装置考核（SVG/SVC/调相机，2026-09-04）
-- ============================================================

-- 15、动态无功补偿装置台账（第27条考核对象；风光储主体适用，火电不适用——清单2 §5 待确认）
drop table if exists vqms_art27_device;
create table vqms_art27_device (
  device_id        bigint       not null auto_increment comment '主键',
  entity_id        bigint       not null                comment '考核主体（逻辑FK）',
...
-- 16、第27条月度对账登记（数值来源：人工登记通知单/对端数据；自动采集预留）
drop table if exists vqms_art27_month;
create table vqms_art27_month (
  id                bigint       not null auto_increment comment '主键',
